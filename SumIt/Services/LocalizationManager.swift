...
final class LocalizationManager: ObservableObject {
    ...
    nonisolated static let translationsData: [String: [String: String]] = [
        ...
        // MARK: App lock
        "lock_biometric_changed": ["en":"Face ID or Touch ID enrollment changed. Enter your code to continue.","uk":"Дані Face ID або Touch ID змінилися. Введи код, щоб продовжити.","ru":"Данные Face ID или Touch ID изменились. Введи код, чтобы продолжить.","es":"El registro de Face ID o Touch ID cambió. Introduce tu código para continuar.","de":"Face-ID- oder Touch-ID-Registrierung hat sich geändert. Gib deinen Code ein.","pl":"Dane Face ID lub Touch ID się zmieniły. Wpisz kod, aby kontynuować."],
        "lock_biometric_unavailable": ["en":"Face ID and Touch ID aren't available on this device.","uk":"Face ID і Touch ID недоступні на цьому пристрої.","ru":"Face ID и Touch ID недоступны на этом устройстве.","es":"Face ID y Touch ID no están disponibles en este dispositivo.","de":"Face ID und Touch ID sind auf diesem Gerät nicht verfügbar.","pl":"Face ID i Touch ID są niedostępne na tym urządzeniu."],
        "lock_no_pin": ["en":"No code is set on this device, so there is nothing to enter.","uk":"На цьому пристрої код не встановлено, тож вводити нічого.","ru":"На этом устройстве код не задан, вводить нечего.","es":"No hay código configurado en este dispositivo, no hay nada que introducir.","de":"Auf diesem Gerät ist kein Code gesetzt, es gibt nichts einzugeben.","pl":"Na tym urządzeniu nie ustawiono kodu, nie ma czego wpisywać."],
