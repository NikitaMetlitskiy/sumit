...
enum KeychainHelper {
    private static let service = "local.sumit-audit.3987d6bb59604f4fa8ca00294f1b6d15"
...
let first = KeychainHelper.setString("audit-first", for: "probe")
let second = KeychainHelper.setString("audit-second", for: "probe")
print("keychain first=\(first), replacement=\(second), latest_value=\(KeychainHelper.getString("probe") == "audit-second")")
KeychainHelper.wipeAll()
